...
<div class="exploit-container" style="padding: 10px 5px; border-radius: 3px; background-color: #0080ff; position: absolute; bottom: 0; width: auto; height: 425px; margin: 2px;">
...
Speed<input value="0" min="0" max="7" type="range" class="slider" id="Character-Speed">

Skin<input value="0" min="0" max="5" type="range" class="slider" id="class-selecter">

Flight Speed<input value="3" min="1" max="200" type="range" class="slider" id="flight-speed">
</div>
</div>
`);
...
document.getElementById('Character-Speed').value = localStorage.getItem('speed') || 0;
document.getElementById('Character-Speed').addEventListener('change', function () {
let speed = speds[Number(this.value)];
Game.speed = ('speed', speed.id);
});
